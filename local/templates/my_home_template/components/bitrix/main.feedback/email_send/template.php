	...
	<?=bitrix_sessid_post()?>
		<div class="row form-group">
			<div class="col-md-12 mb-3 mb-md-0">
				...
				<input type="text" name="user_name" id="fullname" class="form-control" placeholder="Ваше имя" value="<?=$arResult["AUTHOR_NAME"]?>">
			</div>
		</div>
		<div class="row form-group">
			<div class="col-md-12">
				...
				<input type="email" name="user_email" id="email" class="form-control" placeholder="Ваш E-mail" value="<?=$arResult["AUTHOR_EMAIL"]?>">
			</div>
		</div>
		<div class="row form-group">
			<div class="col-md-12">
				...
				<textarea name="MESSAGE" id="message" cols="30" rows="5" class="form-control" placeholder="Сообщение"><?=$arResult["MESSAGE"]?></textarea>
			</div>
		</div>
